...
This example offers WOPI-Proof validation and outputs the results to STDOUT. To use WOPI-Proof when running behind a reverse HTTP proxy, set the following environment variable like this.  
